...
function PaymentForm() {
  ...
  return (
    <div
      className={clsx(
        "origin-right absolute top-0 right-0 bottom-0 text-white z-30 scale-x-0 transition-transform duration-300 ease-in-out h-100 bg-lime-500 w-1/4",
        isVoteOpen && "scale-x-100"
      )}
    >
      <div className={clsx("flex flex-row justify-between items-center border-b border-white pt-12 pb-4")}>
