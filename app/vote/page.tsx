  ...
  return (
    <>
      <section className="h-[580px] relative">
        <div className="absolute bg-black/70 top-0 bottom-0 start-0 end-0" />
        <video
          className="w-full h-full object-cover"
          src={`${process.env.NEXT_PUBLIC_API_BASE_URL}${videos?.[0].url}`}
        />
        <div className="absolute h-full overflow-y-auto start-[150px] top-0 flex flex-col gap-y-4 items-start text-white pe-10 border-e border-white">
          <h1>Videos</h1>
